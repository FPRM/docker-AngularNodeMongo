...
RUN wget https://repo.mongodb.org/apt/ubuntu/dists/xenial/mongodb-org/3.6/multiverse/binary-amd64/mongodb-org-mongos_3.6.1_amd64.deb -O ~/mongodb-org-mongos_3.6.1_amd64.deb
