...
RUN echo $("deb [ arch=amd64,arm64 ] https://repo.mongodb.org/apt/ubuntu/dists/xenial/mongodb-org/3.6/multiverse/" | sudo tee /etc/apt/sources.list.d/mongodb-org-3.6.list)
RUN apt-get update -y    
